...
Shader "Skybox/Procedural-Alter" {
Properties {
	...
	_SkyGama ("Sky Gama", Color) = (1, 1, 1, 1)
	_SkyColorBleed ("Sky Color Bleed", Range(0, 1)) = 1.0
...
SubShader {
	...
	Pass {
		...
		uniform half3 _SkyGama;
		uniform half _AtmosphereThickness;
		uniform half _SkyColorBleed;
		...
		v2f vert (appdata_t v)
		{
			...
			float3 kScatteringWavelength = lerp (
				...
				kDefaultScatteringWavelength+kVariableRangeForScatteringWavelength,
				_SkyGama - (kSkyTintInGammaSpace * _SkyColorBleed)); // using Tint in sRGB gamma allows for more visually linear interpolation and to keep (.5) at (128, gray in sRGB) point
